 ...
 **** airlinev8@0.0.1.bna deployed and currently active
 *
 * 1. Create the Admin Connection instance
 * 2. Connect
 * 3. Create the Business Network Definition Object
 * 4. Update the airlinev8 model in runtime
 * 5. Disconnect
 */
...
const appName = "airlinev8";
// This where I have the archive file for v2.0 of airlinev8
// CHANGE THIS DIRECTORY FOR YOUR Model Project
const bnaDirectory = "./personal/airline-demo/airlinev8";
